function Explorer() {
  return (
    <>
    <div className="xl:mt-32 xl:flex p-2 flex-col bg-[#1F2937] h-[600px] items-center text-center">
        <div className="text-white text-4xl p-1 xl:mt-36  mt-14 font-semibold">Find the Perfect Electronics with CoolGuide
        </div>
       ...
       <div>
        ...
        <button className="h-8 xl:ml-2  bg-white w-24 rounded-lg ">Search</button>
       </div>
       
       
        <div className="grid mt-3 xl:grid-rows-2 grid-rows-3 grid-flow-col  gap-4 ">
